...
# for seurat integration: query also undergoes feature selection
# Feature selection
```{r}
...
saveRDS(gamm.S2.seurat_feat_select, file = "GAMM_S2_feat_select.rds")
saveRDS(human_D205.seurat_feat_select, file = "human_D205_feat_select.rds")
```
