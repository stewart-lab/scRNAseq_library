...
# Create an empty Seurat object to store the subset
#human_D205.seurat.test <- CreateSeuratObject(counts = human_D205.seurat@assays$RNA@counts)
...
saveRDS(human_D205.seurat.test_norm, file= "human_D205_test_norm.rds")
saveRDS(human_D205.seurat.train, file= "human_D205_train.rds")
```
