...
```
# subset cell types in reference
# subset if needed
```{r subset}
...
metadata.gamm <- read.csv("gamm_manual_annot_metadata_S2_mod.txt", row.names = 1, 
            header = TRUE, sep = "\t") # consolidated labels: gamm_manual_annot_metadata_c0.5.txt
