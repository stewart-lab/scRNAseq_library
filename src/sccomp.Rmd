...
## for sccomp I had to install cxx-compiler, sctransform, and Matrix separately, then sccomp
# conda install -c conda-forge cxx-compiler
# conda install -c conda-forge r-sctransform
# conda install -c conda-forge r-matrix (need Matrix 1.6.1) or install.packages('Matrix')
# conda install -c bioconda bioconductor-sccomp
## to install speckle, had to install Rcppannoy
# conda install -c conda-forge r-rcppannoy
# 
## loo should install with sccomp, but if not:
