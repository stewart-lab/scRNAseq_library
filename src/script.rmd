...
``` {r}
x = 3
# z <- read_aligned_data("/w5home/bmoore/scRNAseq/GAMM/output_S1-1_mm_mt/Solo.out/GeneFull/filtered/")
# z_raw <- read_aligned_data("/w5home/bmoore/scRNAseq/GAMM/output_S1-1_mm_mt/Solo.out/GeneFull/raw/")
# project <- "gamm_s1-1"
```
