...
if [ "$confirm" == "y" ] || [ "$confirm" == "Y" ]; then
  ...
  docker build --build-arg username=$(id -u):$(id -g) -t align_fastqs ./pre_pipeline
...
docker build --build-arg username=$(id -u):$(id -g) -t my-scrna-seq:bioinfo_latest ./sc_pipeline
