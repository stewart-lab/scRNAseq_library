...
output <- "/w5home/bmoore/scRNAseq_library/output/output_20250116_155212/"
...
```
```{r}
query.seurat <- readRDS("/w5home/bmoore/scRNAseq_library/output/output_20250121_192632/Day120-pig/Day120-pig_batchcorr_seurat_obj.rds")
colnames(query.seurat@meta.data)
ref.seurat <- readRDS(file = "/w5home/bmoore/scRNAseq_library/output/output_20250121_192632/Day205-human/Day205-human_batchcorr_seurat_obj.rds")
print(colnames(query.seurat))
print(colnames(ref.seurat))
```
```{r}
processed_samples_list <- list(query.seurat[1],ref.seurat[1])
```
